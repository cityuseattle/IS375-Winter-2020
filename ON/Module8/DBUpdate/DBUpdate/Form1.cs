...
namespace DBUpdate
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            connectionString = "Data Source=DESKTOP-BKPGAUU;Initial Catalog=Student;Integrated Security=True;";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //SqlDataAdapter used to perform specific SQL operations such as isnert, delete and update commands
            SqlDataAdapter adapter = new SqlDataAdapter();
            String sql = "";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            //SqlDataAdapter used to perform specific SQL operations
            SqlDataAdapter adapter = new SqlDataAdapter();
            String sql = "";
