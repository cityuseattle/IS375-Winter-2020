...
namespace DivideByZero
{
    class Program
    {
        ...
        {
            // Here, number is greater tha divisor
            int[] number = { 8, 17, 24, 5, 25 };
            int[] divisor = { 2, 0, 0, 5 };

            for (int j = 0; j < number.Length; j++)

                // two different types of exception, i.e. DivideByZeroException and IndexOutOfRangeException raise here
                try
                {
                ...
                // Catch block 1
                // This Cathc block is for handling DivideByZeroException
